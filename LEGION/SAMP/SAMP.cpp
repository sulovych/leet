...
bool CSAMP::tryInit()
{
	...
	g_MiscInfo = *(stMiscInfo**)(g_dwSAMP_Addr + SAMP_MISC_INFO);
	if (g_MiscInfo == nullptr)
		return false;


	g_ScoreboardInfo = *reinterpret_cast<stScoreboardInfo**>(g_dwSAMP_Addr + SAMP_SCOREBOARD_INFO_OFFSET);
...
bool CSAMP::isScoreBoardOpen() {
	return *reinterpret_cast<BYTE*>(*reinterpret_cast<DWORD*>(g_dwSAMP_Addr + 0x21A0B4));
}

bool CSAMP::isChatOpen() {
	return *reinterpret_cast<BYTE*>(*reinterpret_cast<DWORD*>(g_dwSAMP_Addr + 0x12E350) + 0x3C);
}
